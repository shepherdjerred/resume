  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Automation of end-to-end tests}{Created infrastructure and command-line tooling to automatically run end-to-end tests in on ephemeral machines in AWS.}
