...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Package Manager at Posit, PBC (formerly RStudio, PBC)}{Remote}
      {Software Engineer}{September 2021 - Present}
      \resumeItemListStart
        \resumeItem{Front-end}{Migrated front-end build from Webpack to Vite. Re-wrote front-end in TypeScript using the Vue Composition API. Migrated client-side state from Vuex to TanStack Query. }
        \resumeItem{Documentation}{Simplified the build process for the product's documentation using \href{https://earthly.dev/}{Earthly}. Significantly increased the productivity of both developers and technical writers.}
        \resumeItem{Build system}{Analyzed existing build system consisting primarily of Makefiles, Docker, and Jenkins. Rewrote Makefiles to be more understandable, performant, and friendly to developers onboarding to the project. Added support for multiple operating systems and CPU architectures.}
        \resumeItem{End-to-end tests}{Created infrastructure and command-line tooling to run end-to-end tests against many Linux distributions on ephemeral AWS instances.}
      \resumeItemListEnd
