...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{End-to-end tests}{Created infrastructure and command-line tooling to automatically run end-to-end tests on ephemeral machines in AWS.}
        ...
        \resumeItem{Documentation}{Simplified the build process for the product's documentation using \href{Earthly}{https://earthly.dev/}. This significantly increased the productivity of both developers and technical writers.}
        \resumeItem{Build system}{Analyzed existing build system consisting primarily of Makefiles, Docker, and Jenkins. Rewrote Makefiles to be more understandable, performant, and friendly to developers unfamiliar with the project. Added support for multiple operating systems and CPU architectures.}
      \resumeItemListEnd
