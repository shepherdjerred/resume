...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Added support for arm64}{Implemented support for building RStudio Package Manager using the arm64 CPU architecture.}
        ...
        \resumeItem{Feature development}{Implemented front-end support for new RStudio Package Manager features primarily using JavaScript.}
      \resumeItemListEnd
